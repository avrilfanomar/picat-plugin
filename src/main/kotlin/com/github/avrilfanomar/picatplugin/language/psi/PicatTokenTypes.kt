...
object PicatTokenTypes {
    ...
    val KEYWORDS = TokenSet.create(
        MODULE_KEYWORD, END_MODULE_KEYWORD, IMPORT_KEYWORD, EXPORT_KEYWORD,
        INCLUDE_KEYWORD, IF_KEYWORD, THEN_KEYWORD, ELSEIF_KEYWORD, ELSE_KEYWORD,
        END_KEYWORD, FOREACH_KEYWORD, IN_KEYWORD, LOOP_KEYWORD, PRIVATE_KEYWORD,
        TABLE_KEYWORD, INDEX_KEYWORD, RETURN_KEYWORD, CONTINUE_KEYWORD, BREAK_KEYWORD,
        NOT_KEYWORD, FAIL_KEYWORD, TRUE_KEYWORD, FALSE_KEYWORD, CASE_KEYWORD,
        OF_KEYWORD, TRY_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, THROW_KEYWORD,
        USING_KEYWORD, WHILE_KEYWORD, DO_KEYWORD, PASS_KEYWORD, DIV_KEYWORD,
        REM_KEYWORD, MOD_KEYWORD, AND_KEYWORD, OR_KEYWORD, XOR_KEYWORD, IS_KEYWORD
    )

    val OPERATORS = TokenSet.create(
        ARROW_OP, BACKTRACKABLE_ARROW_OP, BICONDITIONAL_OP,
        BACKTRACKABLE_BICONDITIONAL_OP, HASH_BICONDITIONAL_OP, HASH_ARROW_OP,
        HASH_OR_OP, HASH_CARET_OP, HASH_AND_OP, HASH_TILDE_OP, RULE_OP,
        ASSIGN_OP, RANGE_OP, EQUAL, NOT_EQUAL, LESS, GREATER, LESS_EQUAL,
        GREATER_EQUAL, IDENTICAL, NOT_IDENTICAL, PLUS, MINUS, MULTIPLY,
        POWER, DIVIDE, INT_DIVIDE, SHIFT_LEFT, SHIFT_RIGHT,
        SHIFT_RIGHT_TRIPLE_OP, BACKSLASH, CARET, AMPERSAND, PIPE, DOT_OP,
        CONCAT_OP
    )
    ...
    val NUMBERS = TokenSet.create(
        INTEGER, HEX_INTEGER, OCTAL_INTEGER, BINARY_INTEGER, FLOAT
    )
    // Corrected based on BNF `atom` rule
    val ATOMS = TokenSet.create(
