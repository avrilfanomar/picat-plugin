...
import com.github.avrilfanomar.picatplugin.language.psi.PicatProgram
...
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatModuleDeclImpl
...
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatGeneralDirectiveImpl
...
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatListItemsImpl
...
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatCallImpl
...
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatItem_Impl
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatAtomImpl
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatNumberImpl
import com.github.avrilfanomar.picatplugin.language.psi.impl.PicatVariableImpl
// import com.github.avrilfanomar.picatplugin.language.lexer.PicatLexer // Hypothetical Lexer import
...
class PicatParserDefinition : ParserDefinition {
    ...
    override fun createLexer(project: Project): Lexer =
        com.github.avrilfanomar.picatplugin.language.lexer.PicatLexerAdapter()
    ...
    override fun createElement(node: ASTNode): PsiElement {
        ...
        return when (type) {
            PicatTokenTypes.PROGRAM -> PicatProgramImpl(node)
            // Module-related
            PicatTokenTypes.MODULE_NAME -> PicatModuleNameImpl(node)
            PicatTokenTypes.MODULE_DECLARATION_CONTENT -> PicatModuleDeclarationImpl(node)
            PicatTokenTypes.MODULE_DECLARATION -> PicatModuleDeclImpl(node)
            ...
            PicatTokenTypes.DIRECTIVE -> PicatGeneralDirectiveImpl(node)
            ...
            PicatTokenTypes.LIST_ELEMENTS -> PicatListItemsImpl(node)
            ...
            PicatTokenTypes.TERM_CONSTRUCTOR_EXPRESSION ->
                PicatTermConstructorExpressionImpl(node)
            PicatTokenTypes.LIST_COMPREHENSION_EXPRESSION ->
                PicatListComprehensionExpressionImpl(node)
            ...
            PicatTokenTypes.PROCEDURE_CALL -> PicatCallImpl(node)
            PicatTokenTypes.LIST_COMPREHENSION_GOAL ->
                PicatListComprehensionGoalImpl(node)
            ...
            // Item (generic wrapper, might not be needed if all specific types are covered)
            PicatTokenTypes.ITEM_ -> PicatItem_Impl(node)
            // PSI types that might have been missed or were mapped from terminal tokens incorrectly
            PicatTokenTypes.ATOM -> PicatAtomImpl(node)
            PicatTokenTypes.NUMBER -> PicatNumberImpl(node)
