...
public class PicatLoopWhileStatementImpl extends ASTWrapperPsiElement implements PicatLoopWhileStatement {

  public PicatLoopWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
