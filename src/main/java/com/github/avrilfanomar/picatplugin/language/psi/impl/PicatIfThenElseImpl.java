...
public class PicatIfThenElseImpl extends ASTWrapperPsiElement implements PicatIfThenElse {

  public PicatIfThenElseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatBody> getBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatBody.class);
  }

  @Override
  @Nullable
  public PicatElseifClauses getElseifClauses() {
    return findChildByClass(PicatElseifClauses.class);
  }
