...
public class PicatBiconditionalExpressionRestImpl extends ASTWrapperPsiElement implements PicatBiconditionalExpressionRest {

  public PicatBiconditionalExpressionRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitBiconditionalExpressionRest(this);
  }
