...
public class PicatShiftExpressionRestImpl extends ASTWrapperPsiElement implements PicatShiftExpressionRest {

  public PicatShiftExpressionRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitShiftExpressionRest(this);
  }
