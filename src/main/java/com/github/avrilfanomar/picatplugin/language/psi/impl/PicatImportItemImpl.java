...
public class PicatImportItemImpl extends ASTWrapperPsiElement implements PicatImportItem {

  public PicatImportItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PicatModuleName getModuleName() {
    return findNotNullChildByClass(PicatModuleName.class);
  }
