...
public class PicatListComprehensionGoalImpl extends ASTWrapperPsiElement implements PicatListComprehensionGoal {

  public PicatListComprehensionGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitListComprehensionGoal(this);
  }
