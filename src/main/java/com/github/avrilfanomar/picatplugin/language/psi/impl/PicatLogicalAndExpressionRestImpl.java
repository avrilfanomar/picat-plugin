...
public class PicatLogicalAndExpressionRestImpl extends ASTWrapperPsiElement implements PicatLogicalAndExpressionRest {

  public PicatLogicalAndExpressionRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitLogicalAndExpressionRest(this);
  }
