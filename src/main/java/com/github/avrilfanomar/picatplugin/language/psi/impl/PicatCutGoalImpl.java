...
public class PicatCutGoalImpl extends ASTWrapperPsiElement implements PicatCutGoal {

  public PicatCutGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitCutGoal(this);
  }
