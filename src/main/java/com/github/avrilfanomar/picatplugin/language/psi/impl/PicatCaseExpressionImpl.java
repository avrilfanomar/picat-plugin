...
public class PicatCaseExpressionImpl extends ASTWrapperPsiElement implements PicatCaseExpression {

  public PicatCaseExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PicatCaseArms getCaseArms() {
    return findChildByClass(PicatCaseArms.class);
  }
