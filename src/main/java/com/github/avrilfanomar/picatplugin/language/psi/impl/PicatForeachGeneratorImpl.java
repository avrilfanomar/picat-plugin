...
public class PicatForeachGeneratorImpl extends ASTWrapperPsiElement implements PicatForeachGenerator {

  public PicatForeachGeneratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitForeachGenerator(this);
  }
