...
public class PicatIndexAccessSuffixImpl extends ASTWrapperPsiElement implements PicatIndexAccessSuffix {

  public PicatIndexAccessSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitIndexAccessSuffix(this);
  }
