...
public class PicatPatternListImpl extends ASTWrapperPsiElement implements PicatPatternList {

  public PicatPatternListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatPattern> getPatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatPattern.class);
  }
