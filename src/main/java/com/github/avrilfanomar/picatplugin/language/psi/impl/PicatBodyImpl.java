...
public class PicatBodyImpl extends ASTWrapperPsiElement implements PicatBody {

  public PicatBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatGoalSeparator> getGoalSeparatorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatGoalSeparator.class);
  }
