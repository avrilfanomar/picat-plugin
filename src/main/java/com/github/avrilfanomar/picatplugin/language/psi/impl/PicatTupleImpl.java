...
public class PicatTupleImpl extends ASTWrapperPsiElement implements PicatTuple {

  public PicatTupleImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PicatTupleItems getTupleItems() {
    return findChildByClass(PicatTupleItems.class);
  }
