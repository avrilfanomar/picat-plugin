...
public class PicatFalseGoalImpl extends ASTWrapperPsiElement implements PicatFalseGoal {

  public PicatFalseGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitFalseGoal(this);
  }
