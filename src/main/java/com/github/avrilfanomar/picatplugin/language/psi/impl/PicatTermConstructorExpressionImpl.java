...
public class PicatTermConstructorExpressionImpl extends ASTWrapperPsiElement implements PicatTermConstructorExpression {

  public PicatTermConstructorExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitTermConstructorExpression(this);
  }
  ...
  @Override
  @NotNull
  public PicatMapEntries getMapEntries() {
    return findNotNullChildByClass(PicatMapEntries.class);
  }
