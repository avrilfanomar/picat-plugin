...
public class PicatCaseArmImpl extends ASTWrapperPsiElement implements PicatCaseArm {

  public PicatCaseArmImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitCaseArm(this);
  }
