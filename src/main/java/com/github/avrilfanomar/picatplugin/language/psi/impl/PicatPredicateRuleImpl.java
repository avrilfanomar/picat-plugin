...
public class PicatPredicateRuleImpl extends ASTWrapperPsiElement implements PicatPredicateRule {

  public PicatPredicateRuleImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PicatRuleOperator getRuleOperator() {
    return findNotNullChildByClass(PicatRuleOperator.class);
  }
