...
public class PicatIndexModeImpl extends ASTWrapperPsiElement implements PicatIndexMode {

  public PicatIndexModeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitIndexMode(this);
  }
  ...
  @Override
  @Nullable
  public PicatIndexingDetails getIndexingDetails() {
    return findChildByClass(PicatIndexingDetails.class);
  }
