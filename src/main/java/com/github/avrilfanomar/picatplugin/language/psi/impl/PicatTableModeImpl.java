...
public class PicatTableModeImpl extends ASTWrapperPsiElement implements PicatTableMode {

  public PicatTableModeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitTableMode(this);
  }
