...
public class PicatForeachLoopImpl extends ASTWrapperPsiElement implements PicatForeachLoop {

  public PicatForeachLoopImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PicatForeachGenerators getForeachGenerators() {
    return findChildByClass(PicatForeachGenerators.class);
  }
