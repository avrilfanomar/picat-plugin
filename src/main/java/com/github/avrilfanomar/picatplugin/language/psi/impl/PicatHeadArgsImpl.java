...
public class PicatHeadArgsImpl extends ASTWrapperPsiElement implements PicatHeadArgs {

  public PicatHeadArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitHeadArgs(this);
  }
