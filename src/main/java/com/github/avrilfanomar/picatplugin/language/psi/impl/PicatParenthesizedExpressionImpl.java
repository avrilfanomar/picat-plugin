...
public class PicatParenthesizedExpressionImpl extends ASTWrapperPsiElement implements PicatParenthesizedExpression {

  public PicatParenthesizedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
