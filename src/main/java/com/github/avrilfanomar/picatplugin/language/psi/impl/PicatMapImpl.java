...
public class PicatMapImpl extends ASTWrapperPsiElement implements PicatMap {

  public PicatMapImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PicatMapEntries getMapEntries() {
    return findChildByClass(PicatMapEntries.class);
  }
