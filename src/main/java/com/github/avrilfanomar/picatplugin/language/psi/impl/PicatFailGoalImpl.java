...
public class PicatFailGoalImpl extends ASTWrapperPsiElement implements PicatFailGoal {

  public PicatFailGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitFailGoal(this);
  }
