...
public class PicatConcatenationExpressionImpl extends ASTWrapperPsiElement implements PicatConcatenationExpression {

  public PicatConcatenationExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatConcatenationExpressionRest> getConcatenationExpressionRestList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatConcatenationExpressionRest.class);
  }
