...
public class PicatRuleOperatorImpl extends ASTWrapperPsiElement implements PicatRuleOperator {

  public PicatRuleOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitRuleOperator(this);
  }
