...
public class PicatLogicalOrExpressionRestImpl extends ASTWrapperPsiElement implements PicatLogicalOrExpressionRest {

  public PicatLogicalOrExpressionRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitLogicalOrExpressionRest(this);
  }
