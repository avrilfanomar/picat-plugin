...
public class PicatTrueGoalImpl extends ASTWrapperPsiElement implements PicatTrueGoal {

  public PicatTrueGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitTrueGoal(this);
  }
