...
public class PicatLambdaExpressionImpl extends ASTWrapperPsiElement implements PicatLambdaExpression {

  public PicatLambdaExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PicatVariableList getVariableList() {
    return findChildByClass(PicatVariableList.class);
  }
