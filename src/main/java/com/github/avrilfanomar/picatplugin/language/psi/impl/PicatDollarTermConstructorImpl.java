...
public class PicatDollarTermConstructorImpl extends ASTWrapperPsiElement implements PicatDollarTermConstructor {

  public PicatDollarTermConstructorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitDollarTermConstructor(this);
  }
