...
public class PicatUnificationImpl extends ASTWrapperPsiElement implements PicatUnification {

  public PicatUnificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitUnification(this);
  }
