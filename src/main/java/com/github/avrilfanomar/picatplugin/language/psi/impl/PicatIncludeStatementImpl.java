...
public class PicatIncludeStatementImpl extends ASTWrapperPsiElement implements PicatIncludeStatement {

  public PicatIncludeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PicatFileSpec getFileSpec() {
    return findChildByClass(PicatFileSpec.class);
  }
