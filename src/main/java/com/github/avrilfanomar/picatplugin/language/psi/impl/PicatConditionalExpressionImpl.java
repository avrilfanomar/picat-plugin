...
public class PicatConditionalExpressionImpl extends ASTWrapperPsiElement implements PicatConditionalExpression {

  public PicatConditionalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PicatBiconditionalExpression getBiconditionalExpression() {
    return findNotNullChildByClass(PicatBiconditionalExpression.class);
  }
