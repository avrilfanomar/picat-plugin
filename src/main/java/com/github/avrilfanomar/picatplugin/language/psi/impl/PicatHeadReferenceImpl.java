...
public class PicatHeadReferenceImpl extends ASTWrapperPsiElement implements PicatHeadReference {

  public PicatHeadReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitHeadReference(this);
  }
