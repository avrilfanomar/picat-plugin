...
public class PicatConcatenationExpressionRestImpl extends ASTWrapperPsiElement implements PicatConcatenationExpressionRest {

  public PicatConcatenationExpressionRestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitConcatenationExpressionRest(this);
  }
