...
public class PicatGoalSeparatorImpl extends ASTWrapperPsiElement implements PicatGoalSeparator {

  public PicatGoalSeparatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitGoalSeparator(this);
  }
