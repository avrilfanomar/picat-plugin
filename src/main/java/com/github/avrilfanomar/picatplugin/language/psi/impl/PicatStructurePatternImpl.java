...
public class PicatStructurePatternImpl extends ASTWrapperPsiElement implements PicatStructurePattern {

  public PicatStructurePatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitStructurePattern(this);
  }
