...
public class PicatExportSpecImpl extends ASTWrapperPsiElement implements PicatExportSpec {

  public PicatExportSpecImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PicatPredicateSignature getPredicateSignature() {
    return findChildByClass(PicatPredicateSignature.class);
  }
