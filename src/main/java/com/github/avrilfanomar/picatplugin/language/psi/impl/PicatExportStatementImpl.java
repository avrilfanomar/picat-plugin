...
public class PicatExportStatementImpl extends ASTWrapperPsiElement implements PicatExportStatement {

  public PicatExportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PicatExportList getExportList() {
    return findChildByClass(PicatExportList.class);
  }
