...
public class PicatPassGoalImpl extends ASTWrapperPsiElement implements PicatPassGoal {

  public PicatPassGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitPassGoal(this);
  }
