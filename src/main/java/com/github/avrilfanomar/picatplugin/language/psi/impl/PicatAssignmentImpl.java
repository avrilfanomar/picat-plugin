...
public class PicatAssignmentImpl extends ASTWrapperPsiElement implements PicatAssignment {

  public PicatAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PicatAssignableExpression getAssignableExpression() {
    return findNotNullChildByClass(PicatAssignableExpression.class);
  }
