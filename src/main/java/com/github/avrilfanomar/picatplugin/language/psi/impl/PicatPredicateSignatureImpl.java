...
public class PicatPredicateSignatureImpl extends ASTWrapperPsiElement implements PicatPredicateSignature {

  public PicatPredicateSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitPredicateSignature(this);
  }
