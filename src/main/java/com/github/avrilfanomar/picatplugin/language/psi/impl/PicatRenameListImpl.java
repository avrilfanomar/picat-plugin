...
public class PicatRenameListImpl extends ASTWrapperPsiElement implements PicatRenameList {

  public PicatRenameListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatRenameSpec> getRenameSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatRenameSpec.class);
  }
