...
public class PicatCatchBodyImpl extends ASTWrapperPsiElement implements PicatCatchBody {

  public PicatCatchBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitCatchBody(this);
  }
