...
public class PicatMultiplicativeExpressionTailImpl extends ASTWrapperPsiElement implements PicatMultiplicativeExpressionTail {

  public PicatMultiplicativeExpressionTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitMultiplicativeExpressionTail(this);
  }
