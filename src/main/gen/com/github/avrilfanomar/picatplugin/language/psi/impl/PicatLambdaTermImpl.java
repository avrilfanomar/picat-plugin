...
public class PicatLambdaTermImpl extends ASTWrapperPsiElement implements PicatLambdaTerm {

  public PicatLambdaTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitLambdaTerm(this);
  }
  ...
  @Override
  @NotNull
  public PicatVariableList getVariableList() {
    return findNotNullChildByClass(PicatVariableList.class);
  }
