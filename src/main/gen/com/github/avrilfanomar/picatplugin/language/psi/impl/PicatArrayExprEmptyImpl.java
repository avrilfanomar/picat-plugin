...
public class PicatArrayExprEmptyImpl extends ASTWrapperPsiElement implements PicatArrayExprEmpty {

  public PicatArrayExprEmptyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitArrayExprEmpty(this);
  }
