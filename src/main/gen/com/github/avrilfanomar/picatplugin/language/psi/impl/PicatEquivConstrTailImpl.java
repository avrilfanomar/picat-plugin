...
public class PicatEquivConstrTailImpl extends ASTWrapperPsiElement implements PicatEquivConstrTail {

  public PicatEquivConstrTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitEquivConstrTail(this);
  }
