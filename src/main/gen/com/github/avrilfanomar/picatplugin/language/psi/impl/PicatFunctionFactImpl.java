...
public class PicatFunctionFactImpl extends ASTWrapperPsiElement implements PicatFunctionFact {

  public PicatFunctionFactImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitFunctionFact(this);
  }
