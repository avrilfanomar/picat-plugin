...
public class PicatShiftExprImpl extends ASTWrapperPsiElement implements PicatShiftExpr {

  public PicatShiftExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatAdditiveExpr> getAdditiveExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatAdditiveExpr.class);
  }
