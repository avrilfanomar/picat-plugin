...
public class PicatEventPatternImpl extends ASTWrapperPsiElement implements PicatEventPattern {

  public PicatEventPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitEventPattern(this);
  }
