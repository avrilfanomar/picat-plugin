...
public class PicatConjunctiveGoalTailImpl extends ASTWrapperPsiElement implements PicatConjunctiveGoalTail {

  public PicatConjunctiveGoalTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitConjunctiveGoalTail(this);
  }
