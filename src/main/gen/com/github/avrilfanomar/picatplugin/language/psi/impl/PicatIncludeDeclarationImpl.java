...
public class PicatIncludeDeclarationImpl extends ASTWrapperPsiElement implements PicatIncludeDeclaration {

  public PicatIncludeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
