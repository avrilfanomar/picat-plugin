...
public class PicatTryBodyImpl extends ASTWrapperPsiElement implements PicatTryBody {

  public PicatTryBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitTryBody(this);
  }
