...
public class PicatFunctionArgumentListTailImpl extends ASTWrapperPsiElement implements PicatFunctionArgumentListTail {

  public PicatFunctionArgumentListTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitFunctionArgumentListTail(this);
  }
