...
public class PicatEquivConstrImpl extends ASTWrapperPsiElement implements PicatEquivConstr {

  public PicatEquivConstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitEquivConstr(this);
  }
