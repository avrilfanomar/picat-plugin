...
public class PicatXorConstrTailImpl extends ASTWrapperPsiElement implements PicatXorConstrTail {

  public PicatXorConstrTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitXorConstrTail(this);
  }
