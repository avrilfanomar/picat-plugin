...
public class PicatRangeExprImpl extends ASTWrapperPsiElement implements PicatRangeExpr {

  public PicatRangeExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatOrExpr> getOrExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatOrExpr.class);
  }
