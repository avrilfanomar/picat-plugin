...
public class PicatAndConstrImpl extends ASTWrapperPsiElement implements PicatAndConstr {

  public PicatAndConstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitAndConstr(this);
  }
