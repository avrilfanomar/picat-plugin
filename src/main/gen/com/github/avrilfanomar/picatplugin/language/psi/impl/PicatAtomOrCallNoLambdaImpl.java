...
public class PicatAtomOrCallNoLambdaImpl extends ASTWrapperPsiElement implements PicatAtomOrCallNoLambda {

  public PicatAtomOrCallNoLambdaImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitAtomOrCallNoLambda(this);
  }
