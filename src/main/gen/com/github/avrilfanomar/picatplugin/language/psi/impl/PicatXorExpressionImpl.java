...
public class PicatXorExpressionImpl extends ASTWrapperPsiElement implements PicatXorExpression {

  public PicatXorExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatAndExpression> getAndExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatAndExpression.class);
  }
