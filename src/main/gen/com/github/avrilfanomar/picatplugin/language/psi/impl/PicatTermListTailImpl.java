...
public class PicatTermListTailImpl extends ASTWrapperPsiElement implements PicatTermListTail {

  public PicatTermListTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitTermListTail(this);
  }
