...
public class PicatFunctionDirectiveImpl extends ASTWrapperPsiElement implements PicatFunctionDirective {

  public PicatFunctionDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
