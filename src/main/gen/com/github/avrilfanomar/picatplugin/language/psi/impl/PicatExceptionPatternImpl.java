...
public class PicatExceptionPatternImpl extends ASTWrapperPsiElement implements PicatExceptionPattern {

  public PicatExceptionPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitExceptionPattern(this);
  }
