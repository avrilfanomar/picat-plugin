...
public class PicatForeachBodyImpl extends ASTWrapperPsiElement implements PicatForeachBody {

  public PicatForeachBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PicatForeachGoal getForeachGoal() {
    return findNotNullChildByClass(PicatForeachGoal.class);
  }
