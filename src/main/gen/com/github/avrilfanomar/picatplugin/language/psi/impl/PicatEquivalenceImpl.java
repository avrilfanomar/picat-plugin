...
public class PicatEquivalenceImpl extends ASTWrapperPsiElement implements PicatEquivalence {

  public PicatEquivalenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatImplication> getImplicationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatImplication.class);
  }
