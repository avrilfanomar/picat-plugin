...
public class PicatTermConstructorImpl extends ASTWrapperPsiElement implements PicatTermConstructor {

  public PicatTermConstructorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitTermConstructor(this);
  }
