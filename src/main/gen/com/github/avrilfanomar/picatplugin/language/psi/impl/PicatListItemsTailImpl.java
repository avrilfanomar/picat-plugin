...
public class PicatListItemsTailImpl extends ASTWrapperPsiElement implements PicatListItemsTail {

  public PicatListItemsTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitListItemsTail(this);
  }
