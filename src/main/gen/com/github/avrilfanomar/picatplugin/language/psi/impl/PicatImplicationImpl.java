...
public class PicatImplicationImpl extends ASTWrapperPsiElement implements PicatImplication {

  public PicatImplicationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<PicatDisjunctionOr> getDisjunctionOrList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatDisjunctionOr.class);
  }
