...
public class PicatPowerExpressionImpl extends ASTWrapperPsiElement implements PicatPowerExpression {

  public PicatPowerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PicatPrimaryExpression getPrimaryExpression() {
    return findNotNullChildByClass(PicatPrimaryExpression.class);
  }

  @Override
  @Nullable
  public PicatUnaryExpression getUnaryExpression() {
    return findChildByClass(PicatUnaryExpression.class);
  }
