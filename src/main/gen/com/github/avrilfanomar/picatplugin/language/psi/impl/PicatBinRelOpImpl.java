...
public class PicatBinRelOpImpl extends ASTWrapperPsiElement implements PicatBinRelOp {

  public PicatBinRelOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitBinRelOp(this);
  }
