...
public class PicatDisjunctiveGoalImpl extends ASTWrapperPsiElement implements PicatDisjunctiveGoal {

  public PicatDisjunctiveGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitDisjunctiveGoal(this);
  }
  ...
  @Override
  @NotNull
  public List<PicatDisjunctiveGoal> getDisjunctiveGoalList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PicatDisjunctiveGoal.class);
  }
