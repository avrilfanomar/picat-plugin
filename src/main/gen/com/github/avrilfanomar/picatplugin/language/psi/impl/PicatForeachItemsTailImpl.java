...
public class PicatForeachItemsTailImpl extends ASTWrapperPsiElement implements PicatForeachItemsTail {

  public PicatForeachItemsTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitForeachItemsTail(this);
  }
