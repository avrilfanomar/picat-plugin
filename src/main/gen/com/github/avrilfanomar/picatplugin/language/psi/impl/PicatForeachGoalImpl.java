...
public class PicatForeachGoalImpl extends ASTWrapperPsiElement implements PicatForeachGoal {

  public PicatForeachGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitForeachGoal(this);
  }
