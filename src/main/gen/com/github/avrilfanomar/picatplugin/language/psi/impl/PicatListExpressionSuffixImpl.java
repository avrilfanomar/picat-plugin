...
public class PicatListExpressionSuffixImpl extends ASTWrapperPsiElement implements PicatListExpressionSuffix {

  public PicatListExpressionSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitListExpressionSuffix(this);
  }
