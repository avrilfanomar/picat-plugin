...
public class PicatAndConstrTailImpl extends ASTWrapperPsiElement implements PicatAndConstrTail {

  public PicatAndConstrTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitAndConstrTail(this);
  }
