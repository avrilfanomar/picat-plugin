...
public class PicatListExpressionNoComprehensionImpl extends ASTWrapperPsiElement implements PicatListExpressionNoComprehension {

  public PicatListExpressionNoComprehensionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitListExpressionNoComprehension(this);
  }
