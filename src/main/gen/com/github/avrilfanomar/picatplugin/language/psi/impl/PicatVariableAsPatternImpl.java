...
public class PicatVariableAsPatternImpl extends ASTWrapperPsiElement implements PicatVariableAsPattern {

  public PicatVariableAsPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitVariableAsPattern(this);
  }
