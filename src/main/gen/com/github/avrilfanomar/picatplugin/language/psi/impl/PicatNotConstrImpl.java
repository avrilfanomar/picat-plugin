...
public class PicatNotConstrImpl extends ASTWrapperPsiElement implements PicatNotConstr {

  public PicatNotConstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitNotConstr(this);
  }
  ...
  public PicatNotConstr getNotConstr() {
    return findChildByClass(PicatNotConstr.class);
  }
