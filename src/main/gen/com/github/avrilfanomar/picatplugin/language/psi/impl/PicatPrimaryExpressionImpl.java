...
public class PicatPrimaryExpressionImpl extends ASTWrapperPsiElement implements PicatPrimaryExpression {
  ...
  @Override
  @Nullable
  public PicatDotExpression getDotExpression() {
    return findChildByClass(PicatDotExpression.class);
  }

  @Override
  @Nullable
  public PicatNonDotExpression getNonDotExpression() {
    return findChildByClass(PicatNonDotExpression.class);
  }
