...
public class PicatElseifConditionImpl extends ASTWrapperPsiElement implements PicatElseifCondition {

  public PicatElseifConditionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitElseifCondition(this);
  }
