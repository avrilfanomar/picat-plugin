...
public class PicatShiftExpressionTailImpl extends ASTWrapperPsiElement implements PicatShiftExpressionTail {

  public PicatShiftExpressionTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitShiftExpressionTail(this);
  }
