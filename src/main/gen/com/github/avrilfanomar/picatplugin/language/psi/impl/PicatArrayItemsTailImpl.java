...
public class PicatArrayItemsTailImpl extends ASTWrapperPsiElement implements PicatArrayItemsTail {

  public PicatArrayItemsTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitArrayItemsTail(this);
  }
