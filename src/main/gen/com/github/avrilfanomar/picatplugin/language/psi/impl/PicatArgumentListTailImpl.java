...
public class PicatArgumentListTailImpl extends ASTWrapperPsiElement implements PicatArgumentListTail {

  public PicatArgumentListTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitArgumentListTail(this);
  }
