...
public class PicatThrowContentImpl extends ASTWrapperPsiElement implements PicatThrowContent {

  public PicatThrowContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitThrowContent(this);
  }
