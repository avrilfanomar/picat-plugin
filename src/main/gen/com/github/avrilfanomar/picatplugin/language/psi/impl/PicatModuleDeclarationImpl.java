...
public class PicatModuleDeclarationImpl extends ASTWrapperPsiElement implements PicatModuleDeclaration {

  public PicatModuleDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
