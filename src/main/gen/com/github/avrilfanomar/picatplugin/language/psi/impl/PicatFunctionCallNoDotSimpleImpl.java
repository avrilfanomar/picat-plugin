...
public class PicatFunctionCallNoDotSimpleImpl extends ASTWrapperPsiElement implements PicatFunctionCallNoDotSimple {

  public PicatFunctionCallNoDotSimpleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PicatVisitor visitor) {
    visitor.visitFunctionCallNoDotSimple(this);
  }
